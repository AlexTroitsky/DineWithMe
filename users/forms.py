...
import re # for the snippet I copied from the internet
...
# a snippet I copied from this side:  https://gist.github.com/fohlin/771052
# it suppose to use email as username and add first_name and last_name fields to the user model
